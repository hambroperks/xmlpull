...
/*!
 @brief XML Pull Parser is an interface that defines parsing functionlity provided
 ...
 <a href="XmlPullParserException.html">XmlPullParserException.html</a>;
...
/*!
 @brief Returns the namespace prefixe for the given position
